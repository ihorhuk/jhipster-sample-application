...
import com.ihor.myapp.repository.CountryRepository;
import com.ihor.myapp.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.ihor.myapp.domain.Country}.
 */
@RestController
@RequestMapping("/api")
@Transactional
